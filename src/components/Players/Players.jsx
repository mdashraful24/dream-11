...
const Players = ({handleSelectPlayer, selectPlayer, handleRemoveSelectPlayer}) => {
    ...
    return (
        ...
        {/* {showPlayer && <h3 className="text-2xl font-bold">Available Players</h3>} */}
      ...
      {showPlayer ? (
        ...
        <div className="space-y-5">
            {/* <h3 className="text-2xl font-bold">Selected Players ({selectPlayer.length}/6)</h3> */}
            ...
            {/* <button onClick={() => setShowPlayer(true)} className="btn text-lg bg-[#E7FE29] text-black">
                Add More Player
            </button> */}
            <button 
                    onClick={() => {
                    ...
                    className="btn text-lg bg-[#E7FE29] text-black"
                >
                    Add More Player
                </button>
        </div>
...
// setSelectPlayer.length > 0 && setSelectPlayer.length < 7? (
//   <div className="m-10">
//   <h3 className="text-2xl font-bold">Selected Players {setSelectPlayer.length}/6 </h3>
//     {setSelectPlayer.map((player) => (
//       <div key={player.playerId} className="border-2 rounded-xl p-5 m-5 flex justify-between items-center">
//         <div>
//           <h1 className="font-bold text-2xl">{player.name}</h1>
//           <p>{player.type}</p>
//         </div>
//           <button onClick={() => handleRemoveSelectPlayer(player)} className="btn">Delete</button>
//       </div>
//     ))}
//     <button onClick={() => setShowPlayer(true)} className="btn">Add More Player</button>
//   </div>
// ) : (
//   // <h1 className="m-10">No selected players available</h1>
//   alert('maximum player exceeds')
// )}
// </div>